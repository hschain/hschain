...
func (k Keeper) AllocateTokens(
	...
	// general discussions here: https://hschain/issues/2906#issuecomment-441867634
	...
	// TODO consider parallelizing later, ref https://hschain/pull/3099#discussion_r246276376
	for _, vote := range previousVotes {
		validator := k.stakingKeeper.ValidatorByConsAddr(ctx, vote.Validator.Address)

		// TODO consider microslashing for missing votes.
		// ref https://hschain/issues/2525#issuecomment-430838701
